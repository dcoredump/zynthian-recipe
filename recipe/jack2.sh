...
sudo apt-get install -y --no-install-recommends libasound2-dev alsa-base alsa-utils alsa-tools libsndfile1-dev python3 python3-pip
pip3 install --upgrade JACK-Client
cd $ZYNTHIAN_SW_DIR
